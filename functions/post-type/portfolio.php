...
function portfolio_type() {
    ...
    register_post_type(PORTFOLIO_POST_TYPE, [
        "labels" => [
            "name" => esc_html__("Portfolios / Projects", DJS_POSTTYPE_PLUGIN),
            "add_new" => esc_html__("Add New", DJS_POSTTYPE_PLUGIN),
            "add_new_item" => esc_html__("Add New Project", DJS_POSTTYPE_PLUGIN),
            "edit_item" => esc_html__("Add New", DJS_POSTTYPE_PLUGIN),
            "new_item" => esc_html__("New Link", DJS_POSTTYPE_PLUGIN),
            "all_items" => esc_html__("All Portfolios / Projects", DJS_POSTTYPE_PLUGIN),
        ...
        "rewrite" => ["slug" => $current_setup->get("portfolio_slug")],
        "public" => true,
        "menu_position" => 20,
        "public" => true,
        "menu_icon" => DJS_POSTTYPE_PLUGIN_ASSETS_PATH_URI . "/images/portfolio.png",
    ]);
}
